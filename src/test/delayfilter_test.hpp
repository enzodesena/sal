...
namespace sal
{
inline bool DelayFilterTest()
{
  using mcl::IsEqual;

  DelayFilter<Sample> delay_filter_a(1, 100);
  ...
  DelayFilter delay_filter_b = DelayFilter<Sample>(3, 100);
  ...
  DelayFilter delay_filter_c = DelayFilter<Sample>(2, 3);
  ...
  DelayFilter delay_filter_d = DelayFilter<Sample>(1, 5);
  ...
  // Testing DelayLine
  DelayFilter<Sample> delay_line_a(5, 5);
  ...
  ASSERT(mcl::IsApproximatelyEqual(delay_line_a.FractionalReadAt(1.01), -1.173));
  ASSERT(mcl::IsApproximatelyEqual(delay_line_a.FractionalReadAt(1.5), 0.15));
  ASSERT(mcl::IsApproximatelyEqual(delay_line_a.FractionalReadAt(1.7), 0.69));
  ASSERT(mcl::IsApproximatelyEqual(delay_line_a.FractionalReadAt(1.99), 1.473));
...
//  DelayFilter delay_filter_e = DelayFilter<Sample>(0, 100);
