...
bool Microphone::Test()
{
  ...
  TrigMic mic_i(
    Point(0.0, 0.0, 0.0), mcl::AxAng2Quat(0, 0, 1, PI / 4.0), coefficients);
  ...
  TrigMic mic_e(
    Point(1.0, 0.0, 0.0), mcl::AxAng2Quat(0, 0, 1, PI / 2.0), coefficients);
  ASSERT
  (
    IsEqual
    (
  ...
  TrigMic mic_f(
    Point(2.0, 0.0, 0.0), mcl::AxAng2Quat(0, 0, 1, PI / 2.0), coefficients);
  ...
  TrigMic mic_g(
    Point(0.0, 0.0, 0.0), mcl::Quaternion::Identity(), coefficients);
  ASSERT
  (
    IsEqual
    (
  ...
  TrigMic mic_h(
    Point(0.0, 0.0, 0.0), mcl::AxAng2Quat(0, 0, 1, PI / 5.0), coefficients);
  ASSERT
  (
    IsEqual
    (
  ...
  TrigMic mic_p(
    Point(2.0, 1.2, 0.5), mcl::AxAng2Quat(0, 0, 1, 0), coefficients);
  Sample sample = mic_p.RecordPlaneWave(
    0.5, Point(2.0 + cos(0), 1.2 + sin(0), 0.5 + 0.4));
