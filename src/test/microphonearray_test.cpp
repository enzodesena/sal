...
bool MicrophoneArrayTest() {
  ...
  std::vector<Microphone*> microphones_a = microphone_array_a.microphones();
  ...
  std::vector<Microphone*> microphones_b = microphone_array_b.microphones();
  ...
  std::vector<Microphone*> microphones_c = microphone_array_c.microphones();
  ...
  std::vector<Microphone*> stereo_mics =  stereo_mic.microphones();
