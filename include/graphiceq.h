...
public:
  ...
  */
  GraphicEq(const std::vector<Real>& fc, const Real Q, const Real sampling_frequency);
  ...
  * @param sample_rate The sample rate for calculating the filter coefficients
  */
  GraphicEq(const std::vector<Real>& gain, const std::vector<Real>& fc, const Real Q, const Real sampling_frequency);
...
private:
  ...
  * @param sample_rate The sample rate for calculating the filter coefficients
  */
  void InitFilters(const std::vector<Real>& fc, const Real Q, const Real sampling_frequency);
