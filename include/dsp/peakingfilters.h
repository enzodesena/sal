...
class PeakHighShelf : public IirFilter {
 public:
  /**
   * Constructor that initialises an 2nd order high shelf filter with a given
   * cut off frequency
   *
  ...
  /**
   * Constructor that initialises an 2nd order high shelf filter with a given
   * cut off frequency and shelf gain
   *
   * @param fc The cut off frequency of the filter
...
class PeakLowShelf : public IirFilter {
 public:
  /**
   * Constructor that initialises an 2nd order low shelf filter with a given cut
   * off frequency
   *
   * @param fc The cut off frequency of the filter
   * @param Q The quality factor of the filter
...
class PeakingFilter : public IirFilter {
 public:
  /**
   * Constructor that initialises an 2nd order peaking filter with a given cut
   * off frequency
   *
