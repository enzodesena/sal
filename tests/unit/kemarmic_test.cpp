...
bool KemarMic::Test() {
  ...
  ASSERT(mcl::IsEqual(cmp_imp_right_left,
                      buffer_pa.GetLeftReadView()));
  ASSERT(mcl::IsEqual(cmp_imp_right_right,
                      buffer_pa.GetRightReadView()));
  ...
  Signal output_u_left(buffer_u.GetLeftReadView().begin(), buffer_u.GetLeftReadView().end());
  Signal output_u_right(buffer_u.GetRightReadView().begin(), buffer_u.GetRightReadView().end());
  ...
  output_u_left = Signal(buffer_u.GetLeftReadView().begin(), buffer_u.GetLeftReadView().end());
  output_u_right = Signal(buffer_u.GetRightReadView().begin(), buffer_u.GetRightReadView().end());
  ...
  ASSERT(IsEqual(buffer_diffuse.GetLeftReadView(), mcl::Multiply(cmp_diffuse_up_left_ear, normalising_value)));
  ASSERT(IsEqual(buffer_diffuse.GetRightReadView(), mcl::Multiply(cmp_diffuse_up_left_ear, normalising_value)));
  ...
  ASSERT(IsEqual(buffer_diffuse.GetLeftReadView(), mcl::Multiply(cmp_diffuse_elevation_40_azimuth_77_left_ear, normalising_value)));
  ASSERT(IsEqual(buffer_diffuse.GetRightReadView(), mcl::Multiply(cmp_diffuse_elevation_40_azimuth_77_right_ear, normalising_value)));
  
  mic_diffuse.Reset();
  buffer_diffuse.Reset();
  // Check for the other side (hence `azimuth` is positive here)
  mic_diffuse.AddPlaneWave(impulse, Point(cos(azimuth)*cos(elevation), sin(azimuth)*cos(elevation), sin(elevation)), buffer_diffuse);
  ASSERT(IsEqual(buffer_diffuse.GetLeftReadView(), mcl::Multiply(cmp_diffuse_elevation_40_azimuth_77_right_ear, normalising_value)));
  ASSERT(IsEqual(buffer_diffuse.GetRightReadView(), mcl::Multiply(cmp_diffuse_elevation_40_azimuth_77_left_ear, normalising_value)));
  ...
  ASSERT(IsEqual(buffer_compact.GetLeftReadView(), mcl::Multiply(cmp_compact_up_left_ear, normalising_value)));
  ASSERT(IsEqual(buffer_compact.GetRightReadView(), mcl::Multiply(cmp_compact_up_left_ear, normalising_value)));
  ...
  ASSERT(IsEqual(buffer_compact.GetLeftReadView(), mcl::Multiply(cmp_compact_elevation_40_azimuth_77_left_ear, normalising_value)));
  ASSERT(IsEqual(buffer_compact.GetRightReadView(), mcl::Multiply(cmp_compact_elevation_40_azimuth_77_right_ear, normalising_value)));
  
  mic_compact.Reset();
  buffer_compact.Reset();
  // Check for the other side (hence `azimuth` is positive here)
  mic_compact.AddPlaneWave(impulse, Point(cos(azimuth)*cos(elevation), sin(azimuth)*cos(elevation), sin(elevation)), buffer_compact);
  ASSERT(IsEqual(buffer_compact.GetLeftReadView(), mcl::Multiply(cmp_compact_elevation_40_azimuth_77_right_ear, normalising_value)));
  ASSERT(IsEqual(buffer_compact.GetRightReadView(), mcl::Multiply(cmp_compact_elevation_40_azimuth_77_left_ear, normalising_value)));
  ...
  ASSERT(IsEqual(buffer_full.GetLeftReadView(), mcl::Multiply(cmp_full_up_left_ear, normalising_value)));
  ASSERT(IsEqual(buffer_full.GetRightReadView(), mcl::Multiply(cmp_full_up_left_ear, normalising_value)));
  ...
  ASSERT(IsEqual(buffer_full.GetLeftReadView(), mcl::Multiply(cmp_full_elevation_40_azimuth_77_left_ear, normalising_value)));
  ASSERT(IsEqual(buffer_full.GetRightReadView(), mcl::Multiply(cmp_full_elevation_40_azimuth_77_right_ear, normalising_value)));
  
  mic_full.Reset();
  buffer_full.Reset();
  // Check for the other side (hence `azimuth` is positive here)
  mic_full.AddPlaneWave(long_impulse, Point(cos(azimuth)*cos(elevation), sin(azimuth)*cos(elevation), sin(elevation)), buffer_full);
  ASSERT(IsEqual(buffer_full.GetLeftReadView(), mcl::Multiply(cmp_full_elevation_40_azimuth_77_right_ear, normalising_value)));
  ASSERT(IsEqual(buffer_full.GetRightReadView(), mcl::Multiply(cmp_full_elevation_40_azimuth_77_left_ear, normalising_value)));
