...
bool SphericalHeadMic::Test() {
  ...
  Point point_line_left(0.0, distance * cos(ears_angle - PI / 2.0),
  ...
  Point point_line_right(0.0, -distance * cos(ears_angle - PI / 2.0),
                         -distance * sin(ears_angle - PI / 2.0));
  ...
  ASSERT(IsEqual(stream_b.GetLeftReadView(), stream_b.GetRightReadView(),
                 impulse.num_samples()));
