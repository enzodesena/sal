...
bool VectorOpTest() {
  ...
  std::vector<Real> vector_q_padded = Concatenate(Zeros<Real>(0), vector_q);
  ...
  ASSERT(IsEqual<Real>(GetSegment(vector_g, 1, 2, true),
                       BinaryVector<Real>(-2.4, 0.0)));
  ASSERT(IsEqual(GetSegment(vector_g, 2, 2, false), std::vector<Real>()));
  ASSERT(IsEqual<Real>(GetSegment(vector_g, 2, 2, true),
                       BinaryVector<Real>(0.0, 0.0)));
  ...
  std::vector<Real> frames_a_4_cmp = {0.2000, -0.8000, 0.9000, 0,
                                      0.8000, -2.0000, 1.8000, 0,
                                      1.4000, -3.2000, 2.7000};
  ASSERT(IsEqual(OverlapAdd(frames_a, window_d, 4), frames_a_4_cmp));

  // Filter all
  std::vector<std::vector<Real> > set_of_signals_a = {frames_a_1_cmp,
                                                      frames_a_2_cmp};
  ...
  std::vector<Real> filter_all_1_cmp = {0.2000, -0.2000, 0.3000, -1.7000,
                                        4.1000};
  std::vector<Real> filter_all_2_cmp = {0.2000, -1.0000, 2.5000, -3.7000,
                                        5.2000, -6.4000, 5.9000};
  ...
  std::vector<std::vector<Real> > set_of_signals_b = {frames_a_2_cmp,
                                                      frames_a_4_cmp};
  std::vector<std::vector<std::vector<Real> > > set_of_sets_of_input_signals = {
