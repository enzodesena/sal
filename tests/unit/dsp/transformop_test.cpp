...
bool TransformOpTest() {
  ...
  std::vector<Real> vector_l_3_cmp = {0.333333333333333, -0.244016935856292,
                                      0.910683602522959};
  ...
  std::vector<Real> vector_m_9_cmp = {
      1.222222222222222, -0.287886945411706, -0.858709554352006,
      0.363105465825680, 0.042237498424953,  0.194246451014139,
      0.748005645285431, -0.421017219679913, -0.002203563328800};
