...
bool Ism::Test() {
  ...
  OmniMic mic(Point(1.0 * SOUND_SPEED / sampling_frequency,
  ...
  CuboidRoom room(5.0 * SOUND_SPEED / sampling_frequency,
                  ...
                  1000.0 * SOUND_SPEED / sampling_frequency, GainFilter(1.0));
  ...
  //  Ism ism_b(&room_absorption, &source, &mic, peterson, 10,
